 ...
 * finding a proper crypto library, compiling it, adding dependencies etc.
 *
 * Did I mention I'm lazy? :-)
 * The file has had a fair amount of changes, like using std::array instead
 * of raw pointers, and struct field rearranging + alignment for performance
 * reasons.
 */
...
static void sha_compress(hash_state * hs)
{
	...
	sha2_word_t W alignas(32)[SCHEDULE_SIZE];
...
/* init the SHA state */void sha_init(hash_state * hs)
{
